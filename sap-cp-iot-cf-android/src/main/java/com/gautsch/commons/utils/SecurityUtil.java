...
public class SecurityUtil {
	...
	// CIPHER_ALGORITHM PBEWithSHA1AndDESede not available on Android - using BouncyCastle provider instead
	//private static final String CIPHER_ALGORITHM = "PBEWithSHAAnd3KeyTripleDES";
	private static final String CIPHER_ALGORITHM = "PBEwithSHAAND3-KEYTRIPLEDES-CBC";
	...
	private static PrivateKey decryptPrivateKey(String encryptedPrivateKey, String secret)
			throws GeneralSecurityException, IOException {
        //TODO 2
		byte[] encodedPrivateKey = Base64.decode(encryptedPrivateKey, Base64.DEFAULT);
